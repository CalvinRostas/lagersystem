...
- State Backlog
    - Issues isn't assigned to a sprint yet
- State Ready
    - Issue is ready to be worked on
- State In Progress 
    - Issue is assigned to a developer and is worked on
- State In Review
    - Pull Request is reviewed by an assigned developer
- State Testing
    - Issue is currently tested
- State Done
